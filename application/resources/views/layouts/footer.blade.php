        ...
        <script src="{{ asset('js/vendor/jquery.newsTicker.min.js') }}"></script>
        <script src="{{ asset('js/main.js') }}"></script>
    </body>

<!-- Mirrored from wowthemez.com/demos/news24/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Jan 2019 18:47:19 GMT -->
</html>